				...
				<div class="col-md-12">
					<div class="title">
						...
						<div class="title-content">
							<p><?php _e( 'Elvinaa is simple, clean & elegant blog template for bloggers. Elvinaa is crafted with a user friendly approach that has a minimalist look. It is perfect for Freelancers, Writers, Photographers, Bloggers, Magazine, News Editorial etc. Some of the Premium Features include Featured Slider, Left & Right Sidebars, Social Sharing, Footer Widgets etc.', 'elvinaa' ); ?></p>
						</div>
					</div>
				</div>
			</div>
