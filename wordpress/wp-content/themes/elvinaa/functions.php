...
function elvinaa_scripts() {
	...
	wp_enqueue_style( 'elvinaa-responsive', get_template_directory_uri() . '/css/elvinaa-style-responsive.css', array(), '1.0.4');	   
	...
	wp_enqueue_script( 'elvinaa-script', get_template_directory_uri() . '/js/elvinaa-main.js', array('jquery'), '1.0.4', true );		
...
function elvinaa_sticky_header_script() {
 	if(true===get_theme_mod( 'el_sticky_menu',false)) {
 		wp_enqueue_script( 'elvinaa-sticky-script', get_template_directory_uri() . '/js/elvinaa-sticky.js', array('jquery'), '1.0.4', true );		
 	} 
}
